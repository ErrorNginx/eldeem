...
<head>
	...
	<meta name="author" content="Mang agus" />
				...
				<div class="row">
					<div class="col-md-3">
						...
						<ul class="contact-info">
							<li><i class="icon-map"></i>Jl. A.H. Nasution No.105, Cipadung, Kec. Cibiru, Kota Bandung, Jawa Barat 40614
							<li><i class="icon-phone"></i>+ 1235 2355 98</li>
							<li><i class="icon-envelope"></i><a href="#">ukmldmbandung@uinsgd.ac.id</a></li>
							<li><i class="icon-globe"></i><a href="#">www.ukmldmuinbandung.com</a></li>
						</ul>
					</div>
